            ...
            <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
              ...
              <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
                ...
                <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                  ...
                  <a href={profile.instagramurl} className="pl-4">
                    <i className="bx bxl-instagram text-2xl text-white hover:text-yellow"></i>
                  </a>
                </div>
              </div>
                <Link href={'/blog'}><div className="buttons text-center md:text-left">
        ...
        <div className="container flex flex-col items-center py-16 md:py-20 lg:flex-row">
          <div className="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
            ...
            <h4 className="pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
              I'm {profile.name}, a {profile.about}
            </h4>
            ...
            <div className="flex flex-col justify-center pt-6 sm:flex-row lg:justify-start">
              ...
              <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                ...
                <a href={profile.turl} className="pl-4">
                  <i className="bx bxl-twitter text-2xl text-primary hover:text-yellow"></i>
                </a>
                <a href={profile.murl} className="pl-4">
                  <i className="bx bxl-dribbble text-2xl text-primary hover:text-yellow"></i>
                </a>
                <a href={profile.lurl} className="pl-4">
                  <i className="bx bxl-linkedin text-2xl text-primary hover:text-yellow"></i>
                </a>
                <a href={profile.iurl} className="pl-4">
